  ...
  return (
    <div className="yoga-container">
        ...
        <div className="content">
          ...
          <h2>
            <p>Joyful Moments, Timeless Traditions</p>
            <Typewriter
              onInit={(typewriter) => {
                typewriter.typeString('India’s Festivals: A Celebration of Life and Heritage....!');
                typewriter.start();
              }}
            />
          </h2>
          ...
          <div className="content-right">
            <img src="/images/Festivals/holi-1.jpg" alt="" />
          </div>
        </div>
      </div>
      <ScrollUp />
      <div className="wild-page-2">
            ...
            <div className="info">
              {selectedInfo === 'Diwali' && (
                <div className="info-content"> 
                    <h1>Diwali: The Festival of Lights
              ...
              {selectedInfo === 'Holi' && (
                <div className="info-content"> 
                    <h1>Holi – The Festival of Colors
                        <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                            &times;
                        </span>
                    </h1>
              ...
              {selectedInfo === 'Navratri' && (
                <div className="info-content"> 
                    <h1>Navratri – The Nine Nights of Worship & Celebration
                        <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                            &times;
                        </span>
                    </h1>
              ...
              {selectedInfo === 'Raksha' && (
                <div className="info-content"> 
                  <h1>Raksha Bandhan – The Festival of Sibling Bond
                        <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                            &times;
                        </span>
                  </h1>
              ...
              {selectedInfo === 'Ganesh' && (
                <div className="info-content"> 
                    <h1>Ganesh Jayanti – The Birth Anniversary of Lord Ganesha
                        <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                            &times;
                        </span></h1>              
              ...
              {selectedInfo === 'Janmashtami' && (
                <div className="info-content"> 
                    <h1>Janmashtami: The Birth of Lord Krishna
                        <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                            &times;
                        </span>
                    </h1>
        ...
        <div className="wild-page-3">
          <div className="wild-page-3-1">
            ...
            <div className="info">
              {selectedInfo === 'Fitr' && (
                <div className="info-content"> 
                    <h1>Eid al-Fitr: The Festival of Breaking the Fast
                      <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                          &times;
                      </span>
                    </h1>
              ...
              {selectedInfo === 'Adha' && (
                 <div className="info-content"> 
                 <h1>Eid al-Adha: The Festival of Sacrifice
                    <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                        &times;
                    </span>
                 </h1>
              ...
              {selectedInfo === 'Ramadan' && (
                 <div className="info-content"> 
                 <h1>Ramadan: The Holy Month of Fasting and Spiritual Reflection
                    <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                        &times;
                    </span>
                 </h1>
              ...
              {selectedInfo === 'Muharram' && (
                 <div className="info-content"> 
                 <h1>Muharram: The Sacred Month of Remembrance and Reflection
                    <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                        &times;
                    </span>
                 </h1>
        ...
        <div className="wild-page-3">
            ...
            <div className="info">
              {selectedInfo === 'Gurpurabs' && (
                <div className="info-content"> 
                    <h1>Guru Nanak Gurpurab (Guru Nanak Jayanti) : 
                      <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                          &times;
                      </span>
                    </h1>
              ...
              {selectedInfo === 'Vaisakhi' && (
                 <div className="info-content"> 
                 <h1>Vaisakhi: The Festival of Harvest and the Birth of Khalsa 
                    <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                        &times;
                    </span>
                 </h1>
              ...
              {selectedInfo === 'Hola' && (
                 <div className="info-content"> 
                 <h1>Hola Mohalla: The Sikh Festival of Martial Spirit and Brotherhood
                    <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                        &times;
                    </span>
                 </h1>
              ...
              {selectedInfo === 'sikh-Diwali' && (
                 <div className="info-content"> 
                 <h1>Bandi Chhor Divas: The Sikh Festival of Freedom and Justice
                    <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                        &times;
                    </span>
                 </h1>
              ...
              {selectedInfo === 'Maghi' && (
                 <div className="info-content"> 
                 <h1>Maghi: The Sikh Festival of Martyrdom and Courage
                    <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                        &times;
                    </span>
                 </h1>
        ...
        <div className="wild-page-3">
            ...
            <div className="info">
              {selectedInfo === 'Christmas' && (
                <div className="info-content"> 
                    <h1>Christmas: The Celebration of the Birth of Jesus Christ :
                      <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                          &times;
                      </span>
                    </h1>
              ...
              {selectedInfo === 'Friday' && (
                 <div className="info-content"> 
                 <h1>Good Friday: The Day of Christ’s Crucifixion
                    <span className="close-button" onClick={(e) => handleInfoClose(e, 'nationalPark')}>
                        &times;
                    </span>
                 </h1>
                 ...
                 <p>Christians believe that Jesus' death was a sacrifice for the sins of humanity, fulfilling God’s plan for salvation. His death paved the way for his resurrection on Easter Sunday, symbolizing victory over sin and death.</p>
                 ...
                 <p>
                  <ul>
                    <li>1. Jesus' death led to salvation, making it a day of redemption rather than just sorrow.</li>
        ...
        <div className="wild-page-3">
            ...
            <div className="info">
              {selectedInfo === 'Buddha' && (
                <div className="info-content"> 
                    <h1>Buddha Purnima – The Birth, Enlightenment, and Parinirvana of Buddha
