            ...
            <div className="info">
              {selectedInfo === 'Rock' && (
                <div className="info-content"> 
                    <h2>Bhimbetka Rock Paintings</h2>
                    ...
                    <div className="image-container">
                        <figure>
                            <img src="/images/Paintings/Bhimbetka-1.jpg" alt="" />
                        ...
                        <figure>
                            <img src="/images/Paintings/Bhimbetka-2.jpg" alt="" />
              ...
              {selectedInfo === 'Cave' && (
                 <div className="info-content"> 
                 <h2>Ajanta Cave Paintings: A Timeless Masterpiece of Indian Art</h2>
                 ...
                 <div className="image-container">
                        <figure>
                            <img src="/images/Paintings/Ajantha-1.jpg" alt="" />
                        ...
                        <figure>
                            <img src="/images/Paintings/Ajantha-2.jpg" alt="" />
                        </figure>
                    </div>
              ...
              {selectedInfo === 'Madhubani' && (
                 <div className="info-content"> 
                 <h2>Madhubani Painting: A Vibrant Folk Art of India</h2>
                 ...
                 <div className="image-container">
                    ...
                    <figure>
                        <img src="/images/Paintings/Madhubani-1.jpg" alt="" />
                    </figure>
                </div>
              ...
              {selectedInfo === 'Warli' && (
                 <div className="info-content"> 
                 <h2>Warli Painting: The Tribal Art of Maharashtra</h2>
              ...
              {selectedInfo === 'Pattachitra' && (
                 <div className="info-content"> 
                 <h2>Pattachitra Painting: The Timeless Art of Odisha and Bengal</h2>
              ...
              {selectedInfo === 'Tanjore' && (
                 <div className="info-content"> 
                 <h2>Tanjore Painting: The Royal Art of South India</h2>
              ...
              {selectedInfo === 'Kalamkari' && (
                 <div className="info-content"> 
                 <h2>Kalamkari Painting: The Art of Hand-Painted Textiles</h2>
                 ...
                 <div className="image-container">
                    <figure>
                        <img src="/images/Paintings/Kalamkari-1.jpg" alt="" />
