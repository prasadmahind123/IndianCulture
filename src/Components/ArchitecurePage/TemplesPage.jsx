...
const TemplesPage = () => {
  ...
  let currentData = otherTemples.filter((item) => item.id == currentId)[0] || unescoTemples.filter((item) => item.id == currentId)[0] || Jyotirlings.filter((item) => item.id == currentId)[0]
